...
<title>通知查阅</title>
	<meta name="description" content="内部通知内容"/>
...
.loginPanel .zhouhui { font-size:30px;line-height:30px;}
.loginPanel .tz { font-size:20px;line-height:30px;line-height:30px;}
.loginPanel .kd { line-height:30px;}
...
/* 左对齐 */
.left { text-align: left; border: 0px dotted black; width: 99.5%;}
/* 右对齐 */
.light { text-align: light; border: 0px dotted black; width: 99.5%;}
...
<div class="loginPanel normalPanel">
	...
	<div class="zhouhui">通知查阅</div>
		<div class="sm">Notice Consult</div>

	<div class="tel"><img src="/img/wd-2.png" width="375" height="20"></div>

<p class="tz" ><a href="hk.html">香港基本法</a></p>
<p class="tz" ><a href="hk.html">广州工资发放条例</a></p>
<p class="tz" ><a href="wd.html">产品大纲20191216</a></p>


<p><img src="/img/ss.png" width="375" height="2"></a></p>
