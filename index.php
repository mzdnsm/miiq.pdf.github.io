...
.loginPanel .ls { color:#00a0e9 !important; border-radius:4px 4px 0 0;height:40px;text-shadow:0 1px 0 #fff; line-height:30px;font-size:20px; }
...
<img class="qrcode lightBorder" src="/img/hui.jpg">
<div class="info">

 

<p><a href="tel:15507676276"><img src="/img/tel.png" width="70" height="71"></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="sms:15507676276"><img src="/img/sms.png" width="72" height="73"></a></p>

	<div class="zhouhui">姓名：周辉</div>
		<div class="sm">Name:zhou hui</div></p>

	<div class="zw">（职位：客户经理）</div>
			<div class="zm">Customer Manager</div></p>

<div class="info">

	<p><a class="ls"> 友众信业金融信息服务(上海)有限公司 </a>
	<div class="en">Youzhongxinye financial information service (Shanghai) Co., Ltd</div></p>

	<p class="tel">Tel:+86-15507676276</p>
	<p class="ty">E-MAIL:8@122008.com &nbsp; WEB:122008.com</p>

<p class="zt">地址：广州市天河区黄埔大道富力盈隆大厦1310室</p>
	<p class="ztt">Address : Room 1310, Fu Li Ying Long Building, Huangpu Avenue, Tianhe District, Guangzhou</p>
<marquee style="WIDTH: 300px; HEIGHT: 20px" scrollamount="5" direction="Left" >
<div align="left" >
</div >
...
<center >
<p ><font color="#919191" size="3" >保单贷、房抵贷、工薪贷、微粒贷二次贷</font ></p >
</marquee >

<p><img class="weixin lightBorder" src="/img/wx.png"></p>
<div class="huizhou">扫一扫或者按住二维码识别添加微信好友</div>
<br/>
<p><a href="/web/dg.html"><img src="/img/pdf3.png" width="100" height="25"></a></p>
